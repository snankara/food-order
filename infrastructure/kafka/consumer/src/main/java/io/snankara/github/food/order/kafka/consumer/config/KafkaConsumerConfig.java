package io.snankara.github.food.order.kafka.consumer.config;

import io.snankara.github.food.order.config.data.KafkaConfigData;
import io.snankara.github.food.order.config.data.KafkaConsumerConfigData;
